 ...
 */
public class Control_RegistroAdmin {
    private DAO dao;
    
    public Control_RegistroAdmin() {
        dao = new DAO();
    }
    ...
    public int registrarAdmin(String usuario, String correo, String contrasenia, String confirmar){
        if(checkRegistro(usuario, correo, contrasenia, confirmar)<0){
            return checkRegistro(usuario, correo, contrasenia, confirmar);
        }
        dao.registrarAdmin(usuario, correo, contrasenia, confirmar);
        return 0;
    }
